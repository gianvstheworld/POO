...
class Geometry():
    ...
    def insertFormats(self, flag: int):
        if flag == 0: 
            print("\nInserir quadrado") 
        elif flag == 1:
            print("\nInserir retângulo") 
        ...
        try:
            ...
            if flag == 0: 
                self.forms[self.nForms] = Square(sides[0], self.full, self.cor)
                self.nForms += 1
                print("Forma criada com sucesso: ")
                print(str(self.forms[self.nForms]))
            
            if flag == 1:
                self.forms[self.nForms] = Rectangle(sides[0], sides[1], self.full, self.cor)
                self.nForms += 1
                print("Forma criada com sucesso: ")
                print(str(self.forms[self.nForms]))
            
            if flag == 2: 
                self.forms[self.nForms] = Circle(sides[0], self.full, self.cor)
                self.nForms += 1
                print("Forma criada com sucesso: ")
                print(str(self.forms[self.nForms]))
